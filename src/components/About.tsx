  ...
  return (
    <section id="about" className="px-6 py-24 max-w-5xl mx-auto">
      <div className="grid md:grid-cols-2 gap-16 items-start">
        ...
        >
          <p className="font-mono text-xs text-subtle tracking-widest uppercase mb-3">Background</p>
          ...
          <div className="space-y-4 text-sm text-body leading-relaxed">
            ...
            <p>
              ...
              Cloud Infrastructure, or DevSecOps — where operational rigour and engineering
        ...
        >
          <div>
            <p className="font-mono text-xs text-subtle tracking-widest uppercase mb-4">Highlights</p>
